"""Mock Alt Provider para testes de formato unificado."""
...
class MockAltProvider(ProviderPort):
    """
    Provider mock alternativo.

    Usado para testar que formato de resposta e identico entre providers.
    """

    def __init__(
        self,
        default_response: str = "Mock Alt response",
        model: str = "mock-alt-model",
    ) -> None:
        """Inicializar MockAltProvider."""
